...
import {Alert, Container, Placeholder, Row, Spinner} from 'react-bootstrap';
...
import {faHeart, faPrint, faShareNodes} from '@fortawesome/free-solid-svg-icons';
...
export default function DetailPage() {
  ...
  return (
    <Container fluid='lg' className='py-4'>
      ...
      <Row ref={content1Ref}>{commonData && <DetailBanner contentTypeId={contentTypeId} />}</Row>
      ...
      <div className='py-4'>{commonData && <DetailOverView commonData={commonData} />}</div>
      ...
      <div ref={content3Ref} className='py-4'>
        {commonData && <DetailMap coordX={commonData.mapx} coordY={commonData.mapy} title={commonData.title} />}
      </div>
